...
const buildSearchPrompt = (searchData: SearchCafesData) => {
...

  {
    ...
    position?: {
      lat: number;         // If a specific area or location is mentioned, need to provide coordinates
      lng: number;         // If a specific area or location is mentioned, need to provide coordinates
    };
  ...
  If there is only areaKey, district, location in the keyword, return the keyword as an empty string.
  `;

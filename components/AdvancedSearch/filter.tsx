...
import tagData, { tags, TagType } from '@/constants/tags';
  ...
  return (
    <Box sx={{ p: 2, width: 300 }}>
      ...
      <FormControl fullWidth sx={{ mt: 2 }}>
        <InputLabel id="select-multiple-tags-label" sx={{ px: 1, bgcolor: 'white' }}>
          標籤
        </InputLabel>
        <Select
          multiple
      ...
      <Button fullWidth variant="contained" sx={{ mt: 3 }} onClick={handleApplyFilters}>
        套用篩選
      </Button>
    </Box>
  );

  ...
  if (!isLogin) {
    return (
      <ul className="navbar-nav align-items-center">
        ...
        <li className="d-block d-md-none">
          <a href="" className='text-white fs-4'>登入</a>
        </li>
        <li className="d-block d-md-none">
          <a href="" className='text-white fs-4'>註冊</a>
        </li>
      </ul>
    )
  } else {
    return (
      <ul className="navbar-nav align-items-center">
        ...
        <li className="nav-item me-lg-0-5"><a href="" type="button" className="nav-link text-white fs-4">新增店家</a></li>
        ...
        <li className="nav-item"><a href="" className="nav-link text-white d-block d-lg-none fs-4">我的檔案</a></li>
      </ul>
    )
  }
}

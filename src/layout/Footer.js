      ...
      <footer className='bg-primary text-white pt-4 pb-3'>
          <div className="container">
              <div className="d-flex justify-content-between align-items-md-center mb-md-5 mb-4">
                ...
                <div className="navbar-brand p-0 fs-2 me-lg-5"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 40 40" fill="none" className='me-0-5 align-middle nav-logo'>
                ...
                </svg><img src={`${localUrl}/img/findCafe.svg`} alt="" height={30}/></div>
              </div>
